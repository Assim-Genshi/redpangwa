...
const Logo = ({ color = "currentColor", size = 48, className = "" }) => {
  return (
    <div className={className} style={{ width: size, height: size }}>
      {/* Paste your SVG below and replace the `fill` with `color` */}
      <svg
